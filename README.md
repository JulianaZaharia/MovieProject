...
You can download the original datasource here: [Movie Datased Excel file](https://github.com/user-attachments/files/23732332/Movies_Data_Homework.xlsx)
### Tools
...
### Dashboard
<img width="883" height="728" alt="Screenshot 2025-11-24 134231" src="https://github.com/user-attachments/assets/aeddca08-702a-41f6-8432-fa93db0fa46b" />

### M Code
```
let
    Source = Excel.Workbook(File.Contents("C:\Users\jgolu\OneDrive - Administrator\10. Personal\Data analyst\Movies_Data_Homework.xlsx"), null, true),
    ...
    #"Renamed Columns" = Table.RenameColumns(#"Expanded Genres1",{{"Genres.Genre.1", "Genres.Second"}}),
    #"Reordered Columns1" = Table.ReorderColumns(#"Renamed Columns",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Cast_First_ID", "Cast_Second_ID", "Cast_Third_ID", "Cast_Fourth_ID", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    ...
    #"Reordered Columns2" = Table.ReorderColumns(#"Expanded Directors",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Cast_Second_ID", "Cast_Third_ID", "Cast_Fourth_ID", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    ...
    #"Reordered Columns3" = Table.ReorderColumns(#"Expanded Actors",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Actors.Actor", "Cast_Second_ID", "Cast_Third_ID", "Cast_Fourth_ID", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    ...
    #"Renamed Columns1" = Table.RenameColumns(#"Expanded Actors1",{{"Actors.Actor.1", "Actors._2"}}),
    #"Reordered Columns4" = Table.ReorderColumns(#"Renamed Columns1",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Actors.Actor", "Cast_Second_ID", "Actors._2", "Cast_Third_ID", "Cast_Fourth_ID", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    ...
    #"Renamed Columns2" = Table.RenameColumns(#"Expanded Actors2",{{"Actors.Actor.1", "Actors_3"}}),
    #"Reordered Columns5" = Table.ReorderColumns(#"Renamed Columns2",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Actors.Actor", "Cast_Second_ID", "Actors._2", "Cast_Third_ID", "Actors_3", "Cast_Fourth_ID", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    #"Merged Queries6" = Table.NestedJoin(#"Reordered Columns5", {"Cast_Fourth_ID"}, Actors, {"ID"}, "Actors", JoinKind.LeftOuter),
    #"Renamed Columns3" = Table.RenameColumns(#"Merged Queries6",{{"Actors", "Actors_4"}}),
    #"Reordered Columns6" = Table.ReorderColumns(#"Renamed Columns3",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Actors.Actor", "Cast_Second_ID", "Actors._2", "Cast_Third_ID", "Actors_3", "Cast_Fourth_ID", "Actors_4", "Cast_Fifth_ID", "Budget ($)", "Box Office Revenue ($)"}),
    #"Expanded Actors_4" = Table.ExpandTableColumn(#"Reordered Columns6", "Actors_4", {"Actor"}, {"Actors_4.Actor"}),
    #"Merged Queries7" = Table.NestedJoin(#"Expanded Actors_4", {"Cast_Fifth_ID"}, Actors, {"ID"}, "Actors", JoinKind.LeftOuter),
    #"Expanded Actors3" = Table.ExpandTableColumn(#"Merged Queries7", "Actors", {"Actor"}, {"Actors.Actor.1"}),
    #"Renamed Columns4" = Table.RenameColumns(#"Expanded Actors3",{{"Actors.Actor.1", "Actors_5"}}),
    #"Reordered Columns7" = Table.ReorderColumns(#"Renamed Columns4",{"Movie Title", "Release Date", "Wikipedia URL", "Genre_First_ID", "Genres.Genre", "Genre_Second_ID", "Genres.Second", "Director_First_ID", "Directors.Director", "Cast_First_ID", "Actors.Actor", "Cast_Second_ID", "Actors._2", "Cast_Third_ID", "Actors_3", "Cast_Fourth_ID", "Actors_4.Actor", "Cast_Fifth_ID", "Actors_5", "Budget ($)", "Box Office Revenue ($)"}),
    #"Changed Type1" = Table.TransformColumnTypes(#"Reordered Columns7",{{"Budget ($)", Currency.Type}, {"Box Office Revenue ($)", Currency.Type}}),
...
### Recommendations
To 5 genres are Action, Comedy, Drama, Sci-Fi and Adventure. I would recommend Netflix to produce movies under one of these genres as they brought in more in box office revenue based on the data from 2012 to 2016 
